...
\begin{figure}
  \centering
  \subfloat[Thrust Coefficient]{\includegraphics[width = .35\textwidth]{Plots/Figure_1.png}}
  \subfloat[Torque Coefficient]{\includegraphics[width = .35\textwidth]{Plots/Figure_2.png}}

  \subfloat[Power Coefficient]{\includegraphics[width = .35\textwidth]{Plots/Figure_3.png}}\hspace{1em}
  \subfloat[Efficiency]{\includegraphics[width = .35\textwidth]{Plots/Figure_4.png}}
  \label{fig:2}
...
\begin{figure}
  \label{fig:3}
  \centering
  \subfloat[Whatnot]{\includegraphics[width = .35\textwidth]{Plots/Figure_8.png}}
  \subfloat[Whatnot]{\includegraphics[width = .35\textwidth]{Plots/Figure_9.png}}
  \subfloat[Whatwhat]{\includegraphics[width = .35\textwidth]{Plots/Figure_10.png}}
  \caption{Comparison Between Similar Rotors of Varying Diameter \newline Adjusting a propellor's radius does not change the power, thrust, or torque coefficients as long as its geometry remains the same.}
\end{figure}
...
\begin{figure}
  \label{fig:4}
  \centering
  \subfloat[Whatnot]{\includegraphics[width = .35\textwidth]{Plots/Figure_11.png}}
  \subfloat[Whatnot]{\includegraphics[width = .35\textwidth]{Plots/Figure_12.png}}
  \subfloat[Whatwhat]{\includegraphics[width = .35\textwidth]{Plots/Figure_13.png}}
  \caption{Comparison Between Similar Rotors of Varying Diameter \newline Adjusting a propellor's radius does not change the power, thrust, or torque coefficients as long as its geometry remains the same.}
\end{figure}
