...
\begin{figure}
  \centering
  \subfloat[Effectiveness]{\includegraphics[width = .40\textwidth]{Plots/Figure_1.png}}
  \subfloat[Thrust Coefficient]{\includegraphics[width = .40\textwidth]{Plots/Figure_2.png}}

  \subfloat[Torque Coefficient]{\includegraphics[width = .40\textwidth]{Plots/Figure_3.png}}\hspace{1em}
