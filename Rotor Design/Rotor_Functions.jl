#=---------------------------------------------------------------
10/17/2022
Rotor Functions v1 Rotor_Functions.jl
This file was copied from the previous Rotor Analysis project.
More functions will be added as the need arrises.
---------------------------------------------------------------=#
...
"""
    TransonicDrag
This struct is useful for containting the critical Mach number.
"""
struct TransonicDrag <: MachCorrection
    Mcc  # crest critical Mach number
end